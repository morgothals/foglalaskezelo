        ...
        <div class="flex flex-col space-y-8">
            ...
            <div>
                <div class="flex items-center space-x-3">
                    <div class="w-8 h-8 rounded-full bg-red-600 text-white flex items-center justify-center font-bold">1
                    </div>
            ...
            <div class="{{ $selectedHairdresser ? '' : 'opacity-50 pointer-events-none' }}">
                ...
                <div class="mt-4 text-gray-500">
                    (Később ide jön a dátum/időpont picker)
                </div>
            </div>

            {{-- Step 4: Adatok megadása --}}
            <div>
                <div class="flex items-center space-x-3">
                    <div
                        class="w-8 h-8 rounded-full {{ $selectedHairdresser ? 'bg-red-600' : 'bg-gray-300' }} text-white flex items-center justify-center font-bold">
                        4</div>
                    <h3 class="text-lg font-medium text-gray-900">Add meg az adataidat</h3>
                </div>

                <div class="mt-4 space-y-4 {{ !$selectedHairdresser ? 'opacity-50 pointer-events-none' : '' }}">
                    <div>
                    ...
                    <div>
                        <button wire:click="submitAppointment"
                            class="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700">Foglalás</button>
                    </div>
                </div>
            </div>
        </div>
